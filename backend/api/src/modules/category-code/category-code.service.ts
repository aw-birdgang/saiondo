...
import { RelationalCategoryCodeRepository } from '../../database/category-code/infrastructure/persistence/relational/repositories/category-code.repository';
import { CategoryCode } from '../../database/category-code/domain/category-code';

@Injectable()
export class CategoryCodeService {
  constructor(private readonly categoryCodeRepo: RelationalCategoryCodeRepository) {}
