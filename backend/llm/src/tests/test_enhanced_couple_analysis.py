...
from services.enhanced_couple_analysis_service import EnhancedCoupleAnalysisService, CoupleAnalysisResult
...
class TestEnhancedCoupleAnalysisService:
    ...
    def test_analyze_couple_success(self, service, sample_user_data, sample_partner_data):
        """커플 분석 성공 테스트"""
    ...
    def test_analyze_couple_fallback(self, service, sample_user_data, sample_partner_data):
