...
export class ProfileService {
  ...
  async getProfile(request: GetProfileRequest): Promise<GetProfileResponse> {
    try {
      const response = await this.apiClient.get(`${this.baseUrl}/${request.userId}`);
      return {
        ...response.data,
        cached: false,
        fetchedAt: new Date()
  ...
  async updateProfile(request: UpdateProfileRequest): Promise<UpdateProfileResponse> {
    try {
      const response = await this.apiClient.put(`${this.baseUrl}/${request.userId}`, request);
      return response.data;
    } catch (error) {
  ...
  async deleteProfile(request: DeleteProfileRequest): Promise<DeleteProfileResponse> {
    try {
      const response = await this.apiClient.delete(`${this.baseUrl}/${request.userId}`);
      return response.data;
    } catch (error) {
  ...
  async searchProfiles(request: SearchProfilesRequest): Promise<SearchProfilesResponse> {
    try {
      ...
      const response = await this.apiClient.get(`${this.baseUrl}/search?${params}`);
      return response.data;
    } catch (error) {
  ...
  async getProfileStats(request: GetProfileStatsRequest): Promise<GetProfileStatsResponse> {
    try {
      const response = await this.apiClient.get(`${this.baseUrl}/${request.userId}/stats`);
      return response.data;
    } catch (error) {
  ...
  async updateProfileStats(request: UpdateProfileStatsRequest): Promise<UpdateProfileStatsResponse> {
    try {
      const response = await this.apiClient.put(`${this.baseUrl}/${request.userId}/stats`, request.stats);
      return response.data;
    } catch (error) {
  ...
  async followUser(request: FollowUserRequest): Promise<FollowUserResponse> {
    try {
      const response = await this.apiClient.post(`${this.baseUrl}/${request.followingId}/follow`, {
  ...
  async unfollowUser(request: UnfollowUserRequest): Promise<UnfollowUserResponse> {
    try {
      const response = await this.apiClient.delete(`${this.baseUrl}/${request.followingId}/follow`, {
  ...
  async getFollowers(request: GetFollowersRequest): Promise<GetFollowersResponse> {
    try {
      ...
      const response = await this.apiClient.get(`${this.baseUrl}/${request.userId}/followers?${params}`);
      return response.data;
    } catch (error) {
  ...
  async getFollowing(request: GetFollowingRequest): Promise<GetFollowingResponse> {
    try {
      ...
      const response = await this.apiClient.get(`${this.baseUrl}/${request.userId}/following?${params}`);
      return response.data;
    } catch (error) {
  ...
  async isFollowing(followerId: string, followingId: string): Promise<boolean> {
    try {
      const response = await this.apiClient.get(`${this.baseUrl}/${followingId}/followers/${followerId}`);
   ...
   * 이미지 업로드
   */
  async uploadImage(file: File, type: 'avatar' | 'cover'): Promise<{ url: string }> {
    try {
      const formData = new FormData();
      formData.append('image', file);
      formData.append('type', type);

      const response = await this.apiClient.post(`${this.baseUrl}/upload-image`, formData, {
        headers: {
  ...
  async backupProfile(userId: string): Promise<{ downloadUrl: string }> {
    try {
      const response = await this.apiClient.post(`${this.baseUrl}/${userId}/backup`);
      return response.data;
    } catch (error) {
  ...
  async restoreProfile(userId: string, backupData: any): Promise<boolean> {
    try {
      const response = await this.apiClient.post(`${this.baseUrl}/${userId}/restore`, backupData);
   ...
   * 프로필 분석 데이터 조회
   */
  async getProfileAnalytics(userId: string, period: 'week' | 'month' | 'year' = 'month'): Promise<any> {
    try {
      const response = await this.apiClient.get(`${this.baseUrl}/${userId}/analytics?period=${period}`);
      return response.data;
    } catch (error) {
