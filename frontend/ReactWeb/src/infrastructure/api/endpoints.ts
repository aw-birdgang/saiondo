export const ENDPOINTS = {
  ...
  CREATE_PERSONA_PROFILE: (userId: string) => `/persona-profiles/user/${userId}`,
  ...
  RESPOND_INVITATION: (invitationId: string) => `/invitations/${invitationId}/respond`,
  ...
  ADVICE_HISTORY_LATEST: (channelId: string) => `/advice/channel/${channelId}/latest`,
  ...
  PAYMENT_SUBSCRIPTION_HISTORIES: '/payment-subscription/subscription-histories',
