...
export interface IMessageRepository {
  ...
  search(query: string, options?: any): Promise<Message[]>;
  searchByUser(userId: string, query: string): Promise<Message[]>;
  searchByChannel(channelId: string, query: string): Promise<Message[]>;
  ...
  findByType(channelId: string, type: string): Promise<Message[]>;
