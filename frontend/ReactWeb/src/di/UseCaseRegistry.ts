...
export class UseCaseRegistry {
  ...
  private async registerUserUseCases(): Promise<void> {
    const { GetCurrentUserUseCase } = await import('../application/usecases/GetCurrentUserUseCase');
    const { UpdateUserUseCase } = await import('../application/usecases/UpdateUserUseCase');
    const { AuthenticateUserUseCase } = await import('../application/usecases/AuthenticateUserUseCase');
    const { RegisterUserUseCase } = await import('../application/usecases/RegisterUserUseCase');
    const { LogoutUserUseCase } = await import('../application/usecases/LogoutUserUseCase');
  ...
  private async registerChannelUseCases(): Promise<void> {
    const { CreateChannelUseCase } = await import('../application/usecases/CreateChannelUseCase');
    const { InviteToChannelUseCase } = await import('../application/usecases/InviteToChannelUseCase');
    const { LeaveChannelUseCase } = await import('../application/usecases/LeaveChannelUseCase');
  ...
  private async registerMessageUseCases(): Promise<void> {
    const { SendMessageUseCase } = await import('../application/usecases/SendMessageUseCase');
    const { SearchMessagesUseCase } = await import('../application/usecases/SearchMessagesUseCase');
  ...
  private async registerFileUseCases(): Promise<void> {
    const { UploadFileUseCase } = await import('../application/usecases/UploadFileUseCase');
    const { FileDownloadUseCase } = await import('../application/usecases/FileDownloadUseCase');
  ...
  private async registerSystemUseCases(): Promise<void> {
    const { NotificationUseCase } = await import('../application/usecases/NotificationUseCase');
    const { UserPermissionUseCase } = await import('../application/usecases/UserPermissionUseCase');
    const { CacheUseCase } = await import('../application/usecases/CacheUseCase');
    const { RealTimeChatUseCase } = await import('../application/usecases/RealTimeChatUseCase');
    const { UserActivityLogUseCase } = await import('../application/usecases/UserActivityLogUseCase');
    const { MonitoringUseCase } = await import('../application/usecases/MonitoringUseCase');
    const { RedisCacheUseCase } = await import('../application/usecases/RedisCacheUseCase');
    const { WebSocketUseCase } = await import('../application/usecases/WebSocketUseCase');
    const { APMMonitoringUseCase } = await import('../application/usecases/APMMonitoringUseCase');
    const { AnalyticsUseCase } = await import('../application/usecases/AnalyticsUseCase');
    const { SystemManagementUseCase } = await import('../application/usecases/SystemManagementUseCase');
