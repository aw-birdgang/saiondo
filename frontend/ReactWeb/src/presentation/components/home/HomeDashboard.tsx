...
import { QuickActionsGrid, WelcomeMessage } from './';
import AiAdviceCard from "@/presentation/components/assistant/AiAdviceCard";
...
const HomeDashboard: React.FC<HomeDashboardProps> = ({
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-secondary to-secondary-container ${className}`}
    >
      <CenteredContainer>
          ...
          {stats && (
            <Grid cols={{ sm: 1, md: 2, lg: 4 }} gap='lg'>
              ...
              <InfoCard
                ...
                icon='🔔'
                description={
                  t('unread_messages_description') || '새로운 메시지'
                }
                variant={
                  currentStats.unreadMessages > 0 ? 'warning' : 'default'
                }
              />
              <InfoCard
