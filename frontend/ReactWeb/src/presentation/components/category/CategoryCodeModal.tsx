          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                <span className={cn('px-2 py-1 rounded text-sm font-medium', getCategoryColor(code.category))}>
                  {code.category}
                </span>
        ...
        <div className="mb-6">
          ...
          <div className="p-4 bg-secondary/20 rounded-lg">
            <p className="text-sm text-txt-secondary">
              이 카테고리 코드는 대화 분석에서 "{code.description}" 관련 내용을 분류하는 데 사용됩니다.
              AI가 대화를 분석할 때 이 코드를 참고하여 더 정확한 분석을 제공합니다.
            </p>
          </div>
        </div>
