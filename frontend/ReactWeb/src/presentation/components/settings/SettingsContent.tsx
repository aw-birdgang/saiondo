...
import ToggleSetting from '@/presentation/components/settings/ToggleSetting';
import SelectSetting from '@/presentation/components/settings/SelectSetting';
import {
  THEME_OPTIONS,
  LANGUAGE_OPTIONS,
  FONT_SIZE_OPTIONS,
...
const SettingsContent: React.FC<SettingsContentProps> = ({
  ...
  const renderNotificationSettings = () => (
    ...
    >
      ...
      <ToggleSetting
        ...
        onChange={value =>
          onSettingChange('notifications.chatNotifications', value)
        }
      />
      <ToggleSetting
        title='채널 알림'
        ...
        onChange={value =>
          onSettingChange('notifications.channelNotifications', value)
        }
      />
      <ToggleSetting
        title='분석 알림'
        ...
        onChange={value =>
          onSettingChange('notifications.analysisNotifications', value)
        }
      />
      <ToggleSetting
        title='마케팅 알림'
        ...
        onChange={value =>
          onSettingChange('notifications.marketingNotifications', value)
        }
      />
      <ToggleSetting
        title='조용한 시간'
        ...
        onChange={value =>
          onSettingChange('notifications.quietHours.enabled', value)
        }
      />
    </SettingsSection>
  );
  ...
  const renderPrivacySettings = () => (
    ...
    >
      ...
      <ToggleSetting
        ...
        onChange={value =>
          onSettingChange('privacy.allowFriendRequests', value)
        }
      />
      <ToggleSetting
        title='메시지 허용'
  ...
  const renderAccessibilitySettings = () => (
    ...
    >
      ...
      <SelectSetting
        ...
        onChange={value =>
          onSettingChange('accessibility.colorBlindness', value)
        }
      />
    </SettingsSection>
  );
  ...
  const renderDisplaySettings = () => (
    <SettingsSection
      title='표시 설정'
      description='화면 표시 관련 설정을 관리하세요'
    >
      <ToggleSetting
        title='컴팩트 모드'
