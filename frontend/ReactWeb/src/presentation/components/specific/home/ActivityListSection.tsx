    ...
    <div className={cn("animate-fade-in", className)} style={{ animationDelay: '0.8s' }}>
      <div className="flex items-center justify-between mb-6">
        <div className="space-y-1">
          ...
          <p className="text-gray-600 dark:text-gray-400">시스템에서 발생한 최근 활동들을 확인하세요</p>
        </div>
        <div className="flex items-center space-x-2">
          <span className="text-sm text-gray-500 dark:text-gray-400">좌우 스와이프로 편집/삭제</span>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg overflow-hidden">
        ...
        {activities.length === 0 && (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">아직 활동이 없습니다</p>
          </div>
        )}
      </div>
    </div>
