      ...
      <Card variant="elevated" hover="glow" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
        <CardHeader withDivider className="border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle size="lg" className="text-gray-900 dark:text-white">시스템 상태</CardTitle>
              <CardDescription className="text-gray-600 dark:text-gray-400">현재 시스템 상태를 확인하세요</CardDescription>
            </div>
          </div>
        </CardHeader>
            ...
            {systemStatus.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className={cn("text-sm font-semibold px-3 py-1 rounded-full", item.color)}>
                    {item.status}
                  </span>
                </div>
              </div>
      ...
      <Card variant="elevated" hover="glow" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
        <CardHeader withDivider className="border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle size="lg" className="text-gray-900 dark:text-white">실시간 알림</CardTitle>
              <CardDescription className="text-gray-600 dark:text-gray-400">최근 알림 내역</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-6">
