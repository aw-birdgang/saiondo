      ...
      <div className='flex items-start space-x-4 lg:space-x-6'>
        ...
        <div className='flex-1 space-y-3'>
          ...
          <div className='flex items-center space-x-2 pt-3'>
            ...
            <svg
              className='w-3 h-3 lg:w-4 lg:h-4 text-gray-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 group-hover:translate-x-1 transition-all duration-300'
              fill='none'
              stroke='currentColor'
              viewBox='0 0 24 24'
            >
  ...
  return (
    ...
    >
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 lg:mb-10 space-y-4 lg:space-y-0'>
        ...
        <Badge
          variant='info'
          className='animate-pulse bg-gradient-to-r from-red-500 via-pink-500 to-red-600 text-white border-0 shadow-lg w-fit'
        >
          새로운 기능
        </Badge>
      </div>
