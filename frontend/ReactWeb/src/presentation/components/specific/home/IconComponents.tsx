...
// User Profile Icon
export const UserProfileIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
...
// Profile View Icon
export const ProfileViewIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const StatusIndicator: React.FC<{ 
  ...
  <div className={`w-2 h-2 ${color} rounded-full ${animate ? 'animate-pulse' : ''} ${className}`} />
);
