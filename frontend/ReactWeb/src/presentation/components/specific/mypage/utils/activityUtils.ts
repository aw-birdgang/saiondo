...
export const getTypeBadgeColor = (type: ActivityType): string => {
  switch (type) {
    case 'chat': return "bg-blue-100 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400";
    case 'ai': return "bg-purple-100 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400";
    case 'channel': return "bg-green-100 text-green-600 dark:bg-green-900/20 dark:text-green-400";
    case 'analysis': return "bg-orange-100 text-orange-600 dark:bg-orange-900/20 dark:text-orange-400";
  }
}; 