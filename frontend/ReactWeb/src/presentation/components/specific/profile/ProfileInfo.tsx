      ...
      <CardContent className="space-y-4">
        {isEditing ? (
          ...
          <div className="space-y-3">
            <div>
              <span className="text-sm font-medium text-gray-500">{t('display_name')}</span>
            ...
            {profile.website && (
              <div>
                <span className="text-sm font-medium text-gray-500">{t('website')}</span>
                <a
            ...
            <div>
              <span className="text-sm font-medium text-gray-500">{t('member_since')}</span>
