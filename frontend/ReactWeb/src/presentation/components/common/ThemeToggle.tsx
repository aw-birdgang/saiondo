...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({ 
  ...
  const { isDarkMode, toggleTheme, setTheme, theme, isSystemTheme } = useTheme();
                ...
                <div className="p-2">
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 text-sm rounded-md transition-colors duration-200 ${
                      theme === 'light' ? 'bg-primary text-on-primary' : 'hover:bg-focus'
                    }`}
                    style={{
                      backgroundColor: theme === 'light' ? 'var(--color-primary)' : 'transparent',
                      color: theme === 'light' ? 'var(--color-on-primary)' : 'var(--color-txt)'
                    }}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 text-sm rounded-md transition-colors duration-200 ${
                      theme === 'dark' ? 'bg-primary text-on-primary' : 'hover:bg-focus'
                    }`}
                    style={{
                      backgroundColor: theme === 'dark' ? 'var(--color-primary)' : 'transparent',
                      color: theme === 'dark' ? 'var(--color-on-primary)' : 'var(--color-txt)'
                    }}
                  >
                    <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 text-sm rounded-md transition-colors duration-200 ${
                      theme === 'system' ? 'bg-primary text-on-primary' : 'hover:bg-focus'
                    }`}
                    style={{
                      backgroundColor: theme === 'system' ? 'var(--color-primary)' : 'transparent',
                      color: theme === 'system' ? 'var(--color-on-primary)' : 'var(--color-txt)'
                    }}
                  >
                    <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
