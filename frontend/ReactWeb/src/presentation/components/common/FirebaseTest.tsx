...
// import { useFirebase } from '../hooks/hooks/useFirebase';
// import { useFCMToken } from '../hooks/hooks/useFirebase';
// import { useFCMTokenStatus } from '../hooks/hooks/useFirebaseApi';
...
const FirebaseTest: React.FC = () => {
  ...
  const { data: tokenStatus } = useFCMTokenStatus(user?.id || '');
