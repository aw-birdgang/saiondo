...
class AuthGuard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoggedIn =
        userStore.userId != null && userStore.selectedUser != null;
    print(
        '[AuthGuard] isLoggedIn :: ${isLoggedIn} , _userStore.userId :: ${userStore.userId} , _userStore.selectedUser : ${userStore.selectedUser} , routeName :: ${routeName}');
    if (!authStore.isAuthenticated || userStore.selectedUser == null) {
      if (publicRoutes.contains(routeName)) {
        ...
        print(
            '[AuthGuard] publicRoutes.contains(routeName) >>  routeName:: ${routeName}');
        return child;
      }
